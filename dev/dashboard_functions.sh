...
dashboard_users() {
  # Returns the number of users from all activities, except unknown and production user
  # By construction this is the number of analysis users.
  #
  # Usage:
  #    dashboard_users begin_date end_date
  # Output:
  #    Number of users.
  # 
